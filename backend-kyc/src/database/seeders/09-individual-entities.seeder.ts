  ...
  const individualEntitiesData: Partial<IndividualEntity>[] = [
    {
      ...
      id_type: 'passport',
      id_expiry_date: new Date('2030-03-15'),
    ...
    },
    {
      ...
      id_type: 'passport',
      id_expiry_date: new Date('2029-07-22'),
    ...
    },
    {
      ...
      national_id: '1651108A123456',
      id_type: 'national_id',
      id_expiry_date: new Date('2034-11-08'),
    ...
    },
    {
      ...
      national_id: 'RU987654321',
      id_type: 'passport',
      id_expiry_date: new Date('2028-09-14'),
    ...
    },
    {
      ...
      national_id: 'AU123456789',
      id_type: 'passport',
      id_expiry_date: new Date('2031-05-20'),
